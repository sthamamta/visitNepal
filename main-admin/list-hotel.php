    ...
    <div class="row">
        ...
        <div class="col-md-8">
         <div class="panel panel-default">
          ...
          <div class="panel-heading">List of Hotels</div>
        <?php 
            ...
            <?php 
              while ($res = mysqli_fetch_assoc($result)) {?>
                <tr>
                 ...
                 <td> <a onclick="return confirm('Are you sure to delete this item?');" href="../partials/delete.php?id=<?=$res['id']?>&table=hotel" title="Delete"><i class="fa fa-trash" aria-hidden="true"></i></a>| <a href="../main-admin/view-hotel.php?id=<?=$res['id']?>" >view</a>| </td>
                </tr>
            <?php
              }        
            ?>
