            ...
            <?php 
              while ($res = mysqli_fetch_assoc($result)) {?>
                <tr>
                 ...
                 <td> <a onclick="return confirm('Are you sure to delete this item?');" href="../partials/delete.php?id=<?=$res['id']?>&table=places" title="Delete"><i class="fa fa-trash" aria-hidden="true"></i></a>| <a href="../main-admin/view-places.php?id=<?=$res['id']?>" >view</a>| </td>
                </tr>
            <?php
              }        
            ?>
